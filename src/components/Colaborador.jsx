...
function Colaborador(props) {
    ...
    return (
        <article className='w-60 sm:w-72 mb-6 relative'>
            ...
            <div className='bg-white min-h-52 sm:min-h-64 shadow-[5px_5px_15px_rgba(0,0,0,0.08)] rounded-[0px_0px_10px_10px] pt-24 pb-10 font-Montserrat flex flex-col'>
